...
echo "extension=apcu.so" >> /etc/php/5.6/cli/conf.d/20-apcu.ini
echo "apc.enabled=1" >> /etc/php/5.6/cli/conf.d/20-apcu.ini
echo "apc.enable_cli=1" >> /etc/php/5.6/cli/conf.d/20-apcu.ini
