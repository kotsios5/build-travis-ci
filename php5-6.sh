...
sudo echo "extension=apcu.so" >> /etc/php5/apache2/php.ini
sudo echo "apc.enabled=1" >> /etc/php5/apache2/php.ini
sudo echo "apc.enable_cli=1" >> /etc/php5/apache2/php.ini
